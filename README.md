...
├── docs/
│   ├── part3_manual_gradient_descent.md   # Manual calculations (reference for the handwritten PDF)
│   ├── part3_manual_gradient_descent.pdf
│   └── img_*.png                   # Figures generated by the notebooks
└── README.md
```
